...
<a href="#each-page-has-a-url" class="w-toc__header--link">Each page has a URL</a>
----------------------------------------------------------------------------------
...
Ensure individual pages and views in your [Progressive Web App (PWA)](/discover-installable) are deep linkable via URL and that each URL is unique to make them easily shareable on social media.
...
<span class="w-mr--sm">Last updated: Sep 19, 2019 </span>[Improve article](https://github.com/GoogleChrome/web.dev/blob/master/src/site/content/en/lighthouse-pwa/pwa-each-page-has-url/index.md)
