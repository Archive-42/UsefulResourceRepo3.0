...
A [`Boolean`](https://docs.oracle.com/javase/8/docs/api/java/lang/Boolean.html) is a class, or a **reference type**, defined in the standard library. It stores a reference to an object containing a value (a "box").
