...
A `long` on the other hand, is a **primitive type** and part of the language itself. It stores an actual value.

We say that `Long` is the **wrapper type** for `long`, and objects of type `Long` are **boxed** values.
